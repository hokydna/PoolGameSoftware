...
public class Ball {
    ...
    private String colourString; // ADDED
    ...
    public Ball(String colour, double xPosition, double yPosition, double xVelocity, double yVelocity, double mass,
        ...
        this.colourString = colour; // ADDED
     ...
     * @return colourString.
     */
    public String getColourString(){ // ADDED
        return colourString;
    }
    /**
    ...
    public PocketStrategy getStrategy(){ // ADDED
        return strategy;
    }

    public void setActive(boolean isActive){ // ADDED
